...
PYTHONPATH="$DEPS:${PYTHONPATH:-}" "$PY" scripts/r149_mask2former_overfit_rescue.py \
  ...
  --output-json outputs/analysis/r149b_mask2former_instance_overfit_control_metrics.json \
  --checkpoint outputs/r149b_mask2former_instance_overfit_control/model.pt \
  --seed 20260702 \
  --device cuda
