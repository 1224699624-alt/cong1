...
"${PY}" scripts/train_timm_instance_separation_segmenter.py \
  ...
  --output-exp r117_dinov3_instance_sep \
  --checkpoint outputs/timm_instance_sep/r117_dinov3_instance_sep/best.pt \
  --history-json outputs/timm_instance_sep/r117_dinov3_instance_sep/history.json \
  --metrics-json outputs/analysis/r117_dinov3_instance_sep_clean_test_v2_metrics.json \
  --control-metrics-json outputs/analysis/r117_dinov3_instance_sep_original_test_metrics.json \
  --seed 20260717 \
  --device cuda
