...
/home/shenzeyu/.conda/envs/yolo-sam-gpu/bin/python scripts/train_patch_disagreement_arbitrator.py \
  ...
  --output-exp r102_r100_r097_repatch_basic \
  --checkpoint outputs/patch_arbitrator/r102_r100_r097_repatch_basic.pt \
  --metrics-json outputs/analysis/r102_r100_r097_repatch_basic_clean_test_v2_metrics.json \
  --feature-mode basic \
