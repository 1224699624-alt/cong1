...
"$PY" scripts/train_hf_segformer_segmenter.py \
  ...
  --output-exp r157_hf_segformer_smoke \
  --checkpoint outputs/hf_segformer/r157_hf_segformer_smoke/best.pt \
  --history-json outputs/hf_segformer/r157_hf_segformer_smoke/history.json \
  --metrics-json outputs/analysis/r157_hf_segformer_smoke_clean_test_v2_metrics.json \
  --control-metrics-json outputs/analysis/r157_hf_segformer_smoke_original_test_metrics.json \
  --seed 20260702 \
  --device cuda
