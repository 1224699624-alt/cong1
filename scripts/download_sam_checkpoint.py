#!/usr/bin/env python3
"""Download the public Segment Anything checkpoint."""
...
EXPECTED_MD5 = "01ec64d29a2fca3f0661936605ae66f8"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Download the public SAM ViT-B checkpoint.")
    parser.add_argument("--output", default="checkpoints/sam_vit_b_01ec64.pth")
