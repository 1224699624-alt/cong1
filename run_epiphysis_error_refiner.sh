...
REFINER_EXP="error_refiner_unet512_b32"
REFINER_CHECKPOINT="outputs/error_refiner/${DATASET}/best.pt"
REFINER_THRESHOLDS="${REFINER_THRESHOLDS:-0.40,0.45,0.50,0.55,0.60}"
