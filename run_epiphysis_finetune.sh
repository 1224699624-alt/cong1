...
FINETUNED_CHECKPOINT="${FINETUNED_CHECKPOINT:-outputs/sam_finetune/TSRS_RSNA-Epiphysis/best_mask_decoder.pt}"
...
python scripts/evaluate_masks.py \
  --dataset TSRS_RSNA-Epiphysis \
  --split test \
  --pred-dir outputs/predictions_finetuned/TSRS_RSNA-Epiphysis/test/masks
