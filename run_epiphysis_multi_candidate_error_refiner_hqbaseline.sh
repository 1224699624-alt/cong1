...
REFINER_EXP="multi_candidate_error_refiner_hqbaseline_sam_hqsam"
REFINER_CHECKPOINT="${ERROR_ROOT}/best_multi_candidate_hqbaseline_sam_hqsam.pt"
THRESHOLD_JSON="${ERROR_ROOT}/threshold_sweep_val_multi_candidate_hqbaseline_sam_hqsam.json"
...
python scripts/summarize_ablation_metrics.py \
  ...
  --experiments \
    ...
    "${REFINED_EXP_2}" \
    "${REFINER_EXP}" \
  --output "${PRED_ROOT}/${DATASET}_test_multi_candidate_error_refiner_hqbaseline_summary.md"
