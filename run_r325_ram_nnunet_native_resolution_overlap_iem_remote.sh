...
/root/miniconda3/bin/python scripts/train_r325_ram_nnunet_native_resolution_overlap_iem.py \
  ...
  --output outputs/ram_w600/r325_nnunet_native_resolution_overlap_iem \
  --epochs 30 --min-epochs 15 --patience 10 \
  --prior-weight 0.002 --learning-rate 5e-5 \
