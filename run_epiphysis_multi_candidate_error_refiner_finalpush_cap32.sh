...
REFINER_EXP="multi_candidate_error_refiner_sam_hqsam_bc32_aux035"
REFINER_CHECKPOINT="${ERROR_ROOT}/best_multi_candidate_sam_hqsam_bc32_aux035.pt"
THRESHOLD_JSON="${ERROR_ROOT}/threshold_sweep_val_multi_candidate_sam_hqsam_bc32_aux035.json"
...
python scripts/summarize_ablation_metrics.py \
  ...
  --experiments \
    ...
    "${REFINED_EXP_2}" \
    "${REFINER_EXP}" \
  --output "${PRED_ROOT}/${DATASET}_test_multi_candidate_error_refiner_finalpush_cap32_summary.md"
